...
gitree = f"""[![Fork me on Gitee](https://gitee.com/IvanaXu/GMAHealth/widgets/widget_5.svg)](https://gitee.com/IvanaXu/GMAHealth)"""
...
aistduio = f"""[![Website](https://img.shields.io/website?label=aistudio&up_color=violet&up_message=IvanaXu&url=https%3A%2F%2Fshields.io)](https://aistudio.baidu.com/aistudio/personalcenter/thirdview/979775)"""
...
title = f"""{stats}\n{toplangs}\n{wakatime}\n# བཀྲ་ཤིས་བདེ་ལེགས་\n{gitree}\t{wakatime_total}\t{tianchi}\t{yuque}\t{leetcode}\t{aistduio}"""
